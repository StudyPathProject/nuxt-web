    ...
    <div class="w-11/12 mx-auto pt-12">
      <div class="w-full flex flex-direction-col">
        ...
        <div class="right flex-1">
          ...
          <NuxtLink class="font-semibold hover:underline underline-offset-4 transition-all text-gray-200 hover:text-white" v-for="p in products" :to="p.to">{{p.name}}</NuxtLink>
        </div>
      </div>
